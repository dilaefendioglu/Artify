...
object Constants {
    const val BASE_URL = "https://lexica.art/"
    const val GRID_SPAN_COUNT = 2
    const val IMAGE_MIME_TYPE = "image/jpeg"
    const val IMAGE_RELATIVE_PATH = "Pictures/Artify"
    const val USER_EMAIL = "user_email"
    const val USERNAME_REQUIRED = "Username is required"
    const val ERROR_EMAIL_REQUIRED = "E-mail address is required"
    ...
    const val USERNAME_MIN_LENGTH = "Minimum length is 3"
